...
Bill::Bill(int value, int value2)
{
	...
	{
		cout << "¬ведено помилкове значенн€" << endl;
		callDuration = 0;
		pricePerMinute = 0;
	}
}
...
{
	stringstream ss;
	ss << "callDuration= " << callDuration << "   pricePerMinute= " << pricePerMinute << endl;
	return ss.str();
}
...
{
	do {
		cout << "¬вед≥ть к≥льк≥сть хвилин: "; in >> b.callDuration;
		cout << "¬вед≥ть ц≥ну за хвилину:  "; in >> b.pricePerMinute;
